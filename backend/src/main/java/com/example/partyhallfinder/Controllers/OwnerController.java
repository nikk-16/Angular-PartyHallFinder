...
//    public ResponseEntity<String> addOwner(@RequestBody SignupDetails owner) throws Exception {
...
//    }
    ...
    public ResponseEntity<Owner> signUp(@RequestBody SignupDetails owner)throws Exception {
        return ResponseEntity.ok(ownerServiceImpl.addOwner(owner));
    }
