...
public class UserController {
    ...
    public ResponseEntity<User> signUp(@RequestBody SignupDetails user) throws Exception {
    ...
    public ResponseEntity<?> signIn(@RequestBody Credentials credentials) {
        try {
            User user = userServiceImpl.signIn(credentials);
    ...
    public ResponseEntity<Optional<User>> updateUser(@PathVariable String id, @RequestBody User user) throws Exception {
